...
<head>
  ...
  <title>Year 1 Physics Students Marks</title>
  <style>
    body {
...
<body>
  ...
  <div id="content" class="content">
    <h1>Year 1A Physics Students Marks</h1>
    <table>
      <thead>
        <tr>
          <th>Student ID</th>
      ...
      <tbody id="studentTable">
        ...
        $sql = "SELECT student_id, name, class, CAT ,EXAM FROM physics_marks_year1a";
        ...
        if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
            ...
            echo "<td contenteditable='true' class='editable'>" . $row["CAT"] . "</td>";
            echo "<td contenteditable='true' class='editable'>" . $row["EXAM"] . "</td>";
            echo "</tr>";
          }
        } else {
  ...
  <script>
    ...
    function saveMarks() {
      ...
      xhr.open('POST', 'update_marks_a.php', true);

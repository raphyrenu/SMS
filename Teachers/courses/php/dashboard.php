...
<body>
  ...
  <li class="dropdown">
    ...
    <div class="dropdown-content">
     <a href="./marks/year1/year1a.php">Year 1 A </a>
     <a href="./marks/year1/year1b.php">Year 1 B</a>
     <a href="./marks/year1/year1c.php">Year 1 C</a>
     <a href="./marks/year1/year1d.php">Year 1 D</a>
    </div>
  </li>
   <li class="dropdown">
    <a href="#">YEAR 2</a>
    <div class="dropdown-content">
     <a href="./marks/year2/year2a.php">Year 2 A </a>
     <a href="./marks/year2/year2b.php">Year 2 B</a>
     <a href="./marks/year2/year2c.php">Year 2 C</a>
     <a href="./marks/year2/year2d.php">Year 2 D</a>
    </div>
  </li>

...
<head>
    <meta charset="UTF-8">
    <title>Medical Assistance Requests</title>
    <style>
        /* GENERAL CSS */
        * {
            padding: 0;
...
<aside class="sideMenu">
    <div>
        ...
        <a href="./medicalAssistance_requests.php" class="sideLinks sideLinksActive">
            <span><i class='bx bxs-balloon'></i></span>
            <span>M A R</span>
        </a>
...
<main>
    <div class="main">
        <header class="header">
            <h1>Medical Assistance Requests</h1>
        </header>
        <div class="main-content">
            <table>
                ...
                <tbody>
                    ...
                    // Fetch medical assistance requests from the database
                    $sql = "SELECT * FROM medical_assistance_requests";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<tr><td colspan='4'>No medical assistance requests found</td></tr>";
                    }
                    $conn->close();
                    ?>
                </tbody>
